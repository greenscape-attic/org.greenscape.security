package org.greenscape.security.oauth2;
...
import org.greenscape.security.oauth2.util.TestContent;
		...
		try {
			...
			if (TestContent.ACCESS_TOKEN_EXPIRED.equals(accessToken)) {
				...
				OAuthResponse oauthResponse = OAuthRSResponse.errorResponse(HttpServletResponse.SC_UNAUTHORIZED)
						.setRealm(TestContent.RESOURCE_SERVER_NAME).setError(OAuthError.ResourceResponse.EXPIRED_TOKEN)
						.buildHeaderMessage();
			...
			if (TestContent.ACCESS_TOKEN_INSUFFICIENT.equals(accessToken)) {
				...
				OAuthResponse oauthResponse = OAuthRSResponse.errorResponse(HttpServletResponse.SC_FORBIDDEN)
						...
						.setError(OAuthError.ResourceResponse.INSUFFICIENT_SCOPE).buildHeaderMessage();
